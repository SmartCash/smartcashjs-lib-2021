...
# Contributing to smartcashjs-lib
Firstly in terms of structure, there is no particular concept of "smartcashjs developers" in a sense of privileged people.
...
* smartcashjs.slack.com
* #smartcashjs-dev on Freenode IRC
...
To contribute a patch, the workflow is as follows:
  ...
  1. Submit a pull request to https://github.com/smartcashjs/smartcashjs-lib
...
- `smartcashjs.script.decompile` is consensus bound only,  it does not reject based on policy.
- `smartcashjs.script.compile` will try to adhere to bitcoin-core `IsStandard` policies rules. (eg. minimalpush in https://github.com/smartcashjs/smartcashjs-lib/pull/638)

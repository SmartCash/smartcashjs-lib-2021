...
import { Payment, PaymentFunction, PaymentOpts, Stack, StackFunction } from './index';
import * as lazy from './lazy';
const typef = require('typeforce');
const OPS = bscript.OPS;

const bs58check = require('./../../src/smartcash/bs58smartcheck/index.js');
...
export function p2sh(a: Payment, opts?: PaymentOpts): Payment {
    ...
    lazy.prop(o, 'input', () => {
        ...
        return bscript.compile(([] as Stack).concat(bscript.decompile(a.redeem.input) as Stack, a.redeem.output));
    });
    lazy.prop(o, 'witness', () => {
    ...
    if (opts.validate) {
        ...
        if (a.output) {
            if (a.output.length !== 23 || a.output[0] !== OPS.OP_HASH160 || a.output[1] !== 0x14 || a.output[22] !== OPS.OP_EQUAL)

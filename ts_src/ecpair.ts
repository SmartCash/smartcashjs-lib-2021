...
class ECPair implements ECPairInterface {
    ...
    constructor(private __D?: Buffer, private __Q?: Buffer, options?: ECPairOptions) {
        this.lowR = false;
    ...
    get publicKey(): Buffer {
        if (!this.__Q) this.__Q = ecc.pointFromScalar(this.__D, this.compressed) as Buffer;
        return this.__Q;
    }
...
function fromWIF(wifString: string, network?: Network | Network[]): ECPair {
    ...
    if (types.Array(network)) {
        ...
        if (version !== (network as Network).wif) throw new Error('Invalid network version');
    }

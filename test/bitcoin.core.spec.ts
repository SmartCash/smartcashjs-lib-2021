...
describe('Bitcoin-core', () => {
    ...
    describe('address.toBase58Check', () => {
        ...
        base58KeysValid.forEach((f) => {
            ...
            const network: any = params.isTestnet ? bitcoin.networks.testnet : bitcoin.networks.bitcoin;
    ...
    describe('ECPair.fromWIF', () => {
        const allowedNetworks = [bitcoin.networks.bitcoin, bitcoin.networks.testnet];

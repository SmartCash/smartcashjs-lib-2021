...
describe('ECPair', () => {
    ...
    describe('fromWIF', () => {
        ...
        fixtures.invalid.fromWIF.forEach((f) => {
            it('throws on ' + f.WIF, () => {
                assert.throws(() => {
                    const networks = f.network ? (NETWORKS as any)[f.network] : NETWORKS_LIST;
    ...
    describe('optional low R signing', () => {
        ...
        const lowRKeyPair = ECPair.fromWIF('L3nThUzbAwpUiBAjR5zCu66ybXSPMr2zZ3ikp' + 'ScpTPiYTxBynfZu');
